...
import { Box, Container, Typography, Paper, Grid, Button, CircularProgress, Divider, Tabs, Tab, TextField } from '@mui/material';
...
// Main Project Manager Interface Component
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={4}>
              <Paper sx={{ p: 3, height: '100%', display: 'flex', flexDirection: 'column' }}>
                <Typography variant="h5" gutterBottom>Communication</Typography>
